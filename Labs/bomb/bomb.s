...
0000000000400ee0 <phase_1>: # 就是将输入的字符与内存地址为 0x402400 开头字符串的的进行比较
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp # 栈指针 - 8
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi # phase_1 的参数没变，rdi, 将 esi（第二个参数） 设置为 0x402400（内存地址）
  400ee9:	e8 4a 04 00 00       	call   401338 <strings_not_equal> # 调用函数
  400eee:	85 c0                	test   %eax,%eax # 返回值进行比较 eax & eax
  400ef0:	74 05                	je     400ef7 <phase_1+0x17> # ZF eax = 0
  400ef2:	e8 43 05 00 00       	call   40143a <explode_bomb> # 失败
...
0000000000400efc <phase_2>:
  ...
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp) # rsp == 1 , 否则报错
  400f0e:	74 20                	je     400f30 <phase_2+0x34> # rsp == 1 跳转到 400f30
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax # eax = 0x0
  400f1a:	01 c0                	add    %eax,%eax # 2 * 0x0
  400f1c:	39 03                	cmp    %eax,(%rbx) # 0x4 == 2 * 0x0 = 2
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	call   40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx # rbx = 0x8
  400f29:	48 39 eb             	cmp    %rbp,%rbx 
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx # rbx = 0x4
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp # rbp = 0x18
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx # rsp + 0xc 第4个参数
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx # rsp + 0x8 第3个参数
  ...
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> # 超过 7 则失败
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax # eax 第一个数
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8) # 根据第一个数，跳转到不同的地址
...
0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp # edx = 14, esi = 0, edi = 第一个数
  400fd2:	89 d0                	mov    %edx,%eax # eax 14
  400fd4:	29 f0                	sub    %esi,%eax # eax - esi -> eax 14
  400fd6:	89 c1                	mov    %eax,%ecx # eax -> ecx 14
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx # ecx >> 31 = 0
  400fdb:	01 c8                	add    %ecx,%eax # ecx + eax -> eax 14
  400fdd:	d1 f8                	sar    %eax # 从 gdb 调试看变为了 7, 应该是除以2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # ecx = rax + rsi = rax + 0 = 7
  400fe2:	39 f9                	cmp    %edi,%ecx
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> # edi >= 7
  ...
  400ff9:	7d 0c                	jge    401007 <func4+0x39> # edi <= 7
...
000000000040100c <phase_4>:
  ...
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) # 第一个数字 <= 15
  401033:	76 05                	jbe    40103a <phase_4+0x2e> 
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx # 14 -> edx 第3个参数
  40103f:	be 00 00 00 00       	mov    $0x0,%esi # 0  -> esi 第2个参数
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi # 第一个数 -> edi 第 1 个参数 
  401048:	e8 81 ff ff ff       	call   400fce <func4>
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c> # 不相等或者非零
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51> # rsp + 0xc == 0
...
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx
  401063:	48 83 ec 20          	sub    $0x20,%rsp # 分配栈20个字节
  401067:	48 89 fb             	mov    %rdi,%rbx # 将输出放入 rbx 中
  ...
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx # 我们输入为字符串，rbx + 1 -> ecx，取得一个值 x，x 为输入字符的对应 ascii 表的数
  40108f:	88 0c 24             	mov    %cl,(%rsp) # 取 ecx 低8位 -> (%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx 
  401096:	83 e2 0f             	and    $0xf,%edx # 0xf & edx -> edx， 取 edx 的低4位
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx # (4040b0 + rdx) -> edx， 0x4024b0 起的字符为 maduiersnfotvbylSo
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1) # 将 dl 放入 -> rsp + rax + 0x10 的位置，
  4010a4:	48 83 c0 01          	add    $0x1,%rax # rax ++
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax # rax =? 6
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp) # 放入字符串 \0 结尾字符
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi # "flyers"
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi # 将起始位置放入第一个参数，
  4010bd:	e8 76 02 00 00       	call   401338 <strings_not_equal> # 拿出来取低4位，+ 0x4024b0 地址获取的六个字符为 "flyers"
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	call   40145c <read_six_numbers> # 读取6个数放在 rsp 中，每4个字节存储一个数字
  40110b:	49 89 e6             	mov    %rsp,%r14
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d
  401114:	4c 89 ed             	mov    %r13,%rbp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax # 第一个数字
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax # x1 - 1 <= 5
  ...
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax # eax = x2, 偏移4字节，第二个数
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) # 跟第一个数比较
  40113e:	75 05                	jne    401145 <phase_6+0x51> # 不相等跳转
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx # ebx = 2
  401148:	83 fb 05             	cmp    $0x5,%ebx 
  40114b:	7e e8                	jle    401135 <phase_6+0x41> # ebx <= 5 这里循环是要求输入的6个数不相等
  40114d:	49 83 c5 04          	add    $0x4,%r13 # rsp 指向第二个数
  401151:	eb c1                	jmp    401114 <phase_6+0x20> # 这里又一个循环，要求每个数不相等且 <= 6
  ...
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> # 循环，把 rsp 后续6个数，变为 7 - xi
  40116f:	be 00 00 00 00       	mov    $0x0,%esi # esi -> 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx # rax = [R[rdx] + 0x8]，递归寻找到链表的第 7 - xi 个值
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82> # 这里循环是指若是 7 - xi > 1, 则取 0x6043d0 + 0x8 * (7-xi-1)
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx # edx -> 0x6032d0
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi # 这里循环是指将 rsp + 20 开始，指向以 0x6032d0 为开头的链表，
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx # ecx -> 7 - xi
  40119a:	83 f9 01             	cmp    $0x1,%ecx # 7 - xi <= 1
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax # 若 7 - xi > 1, eax -> 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx # edx -> 0x6032d0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx # rbx = M[R[rsp] + 20] 链表的第 7 - x1 个值的地址
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax # rsp = R[rsp] + 28
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi # rsi = R[rsp] + 50
  4011ba:	48 89 d9             	mov    %rbx,%rcx # rcx -> 链表的第 7 - x1 个值的地址
  4011bd:	48 8b 10             	mov    (%rax),%rdx # rdx -> 链表的第 7 - x2 个值的地址
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) # 将 链表的第 7 - x2 个值的地址 放在 链表的第 7 - x1 个值的地址后8位的地址中，形成一个新的链表
  4011c4:	48 83 c0 08          	add    $0x8,%rax #
  4011c8:	48 39 f0             	cmp    %rsi,%rax # 递归形成新链表
  4011cb:	74 05                	je     4011d2 <phase_6+0xde> #
  4011cd:	48 89 d1             	mov    %rdx,%rcx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) # rdx 为旧链表的第 7 - x6 个值的地址
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp # ebp -> 5
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax # rax 新链表的第2个值的地址
  4011e3:	8b 00                	mov    (%rax),%eax # eax -> 新链表的第2个值
  4011e5:	39 03                	cmp    %eax,(%rbx) # 若是 新链表的第一个值大于新链表的第二值
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa> 
  4011e9:	e8 4c 02 00 00       	call   40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx
  4011f2:	83 ed 01             	sub    $0x1,%ebp             #                                          7-x5=1            7-x6=2         7-x1=3            7-x2=4          7-x3=5           7-x4=6
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb> # 这里就表明新链表的值为递减的，先获取原链表的值 332(0x6032d0) -> 168(0x6032e0) -> 924(0x6032f0) -> 691(0x603300) -> 477(0x603310) -> 443(0x603320)
  4011f7:	48 83 c4 50          	add    $0x50,%rsp # 答案：4 3 2 1 6 5
  4011fb:	5b                   	pop    %rbx
  4011fc:	5d                   	pop    %rbp
...
000000000040131b <string_length>: # 字符串数组是以 '\0' 结尾，string_length 通过将遍历字符串数组知道遇到 '\0'
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi) # 间接寻址 == 0 retutn 0
  40131e:	74 12                	je     401332 <string_length+0x17>
  401320:	48 89 fa             	mov    %rdi,%rdx
  401323:	48 83 c2 01          	add    $0x1,%rdx # rdx + 1 (内存地址+1)
  401327:	89 d0                	mov    %edx,%eax # 获取低32位
  401329:	29 f8                	sub    %edi,%eax # 低32位相减，若小于32位则=0, eax - edi -> eax
  40132b:	80 3a 00             	cmpb   $0x0,(%rdx) # cmpb 比较一个字节，(%rdx) 间接寻址, m(%rdx) - 0
  40132e:	75 f3                	jne    401323 <string_length+0x8> # 不为0，不相等就跳转
  401330:	f3 c3                	repz ret 
  401332:	b8 00 00 00 00       	mov    $0x0,%eax
  401337:	c3                   	ret    

0000000000401338 <strings_not_equal>: # 返回 0 相等，返回 1 不相等
  401338:	41 54                	push   %r12
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx # 第一个参数保存在 rbx
  40133f:	48 89 f5             	mov    %rsi,%rbp # 第二个参数保存在 rbp string_length 可能会改变 rdi 和 rsi
  401342:	e8 d4 ff ff ff       	call   40131b <string_length>
  401347:	41 89 c4             	mov    %eax,%r12d # 将 string_length(arg1) 的结果保存在 r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi  # 计算 arg2 的 length
  40134d:	e8 c9 ff ff ff       	call   40131b <string_length>
  401352:	ba 01 00 00 00       	mov    $0x1,%edx  # 先将 1 放入结果
  401357:	41 39 c4             	cmp    %eax,%r12d # 比较 arg2 和 arg1 的 length
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>  # 长度不相等跳转至结果处返回 1
  40135c:	0f b6 03             	movzbl (%rbx),%eax # M[rbx] 零扩展双字 exa 
  40135f:	84 c0                	test   %al,%al # al & al
  401361:	74 25                	je     401388 <strings_not_equal+0x50> # 若是 M[rbx] 低8位 ==0 则说明两者都为空字符串 返回 0
  401363:	3a 45 00             	cmp    0x0(%rbp),%al # 比较低8位字符
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a>
  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57> # 不相等则返回 1
  40136a:	3a 45 00             	cmp    0x0(%rbp),%al
  40136d:	0f 1f 00             	nopl   (%rax)
  401370:	75 24                	jne    401396 <strings_not_equal+0x5e>
  401372:	48 83 c3 01          	add    $0x1,%rbx # rbx内存地址 + 1
  401376:	48 83 c5 01          	add    $0x1,%rbp # rbp内存地址 + 1
  40137a:	0f b6 03             	movzbl (%rbx),%eax
  40137d:	84 c0                	test   %al,%al # 判断是否是为 '\0' 
  40137f:	75 e9                	jne    40136a <strings_not_equal+0x32> # 未到字符末尾，继续判断
  401381:	ba 00 00 00 00       	mov    $0x0,%edx # 到字符末尾返回 0 相等
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp # 栈指针 - 0x18
  401460:	48 89 f2             	mov    %rsi,%rdx  # rsi -> rdx 第3个参数
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx # rcx = rsi + 0x4 第4个参数
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax # rax = rsi + 0x14
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp) # M[R[rsp]+0x8] = rax 使用栈存储 rsi + 0x14
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax # rax = rsi + 0x10
  401474:	48 89 04 24          	mov    %rax,(%rsp) # M[R[rsp]] = rax 使用栈存储 rsi + 0x14
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9 # r9 = rsi + 0xc 第6个参数
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8 # r8 = rsi + 0x8 第5个参数 
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi # esi = 0x4025c3
  401485:	b8 00 00 00 00       	mov    $0x0,%eax 
  40148a:	e8 61 f7 ff ff       	call   400bf0 <__isoc99_sscanf@plt> # 6个参数（栈存储了两个参数）
